    ...
    public class App : Application
    {
        ...
        public override void OnFrameworkInitializationCompleted()
        {
            if (this.ApplicationLifetime is IClassicDesktopStyleApplicationLifetime desktop)
            {
                ...
                var npccar = new Models.NonPlayerCar(330, 1425, "car_1_blue.png", "NPCCarCoordinatesPathTestWorld.json");
                ...
                var npcpedestrian = new Models.Pedestrian(1625,525, "man.png", "NPCPedestrian1CoordinatesPathTestWorld.json");
